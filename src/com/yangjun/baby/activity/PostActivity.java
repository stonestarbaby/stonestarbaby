...
import com.yangjun.baby.adapter.ForumAdapter.ForumItemViewCache;
...
public class PostActivity extends SherlockActivity{
	...
	private void setForumHead(Forum forum){
		ForumItemViewCache forumCache=new ForumItemViewCache(this);
		forumCache.getNicknameText().setText(forum.getNickName());
		forumCache.getReplyText().setText(forum.getReplyNum());
		forumCache.getViewText().setText(forum.getViewNum());
		forumCache.getTitleText().setText(forum.getPostTitle());
		forumCache.getTimeText().setText(forum.getPostTime());
	}
	...
	private class ForumItemViewCache{
    	private PostActivity baseView;
    	...
    	public ForumItemViewCache(PostActivity view){
    		this.baseView=view;
    	}
